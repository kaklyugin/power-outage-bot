...
public class PowerOutageTimetableLoader {
    ...
    public PowerOutageTimetableLoader(DonEnergoHttpClient donEnergoHttpClient, PowerOutageRepository powerOutageRepository) {
    ...
    public void loadPowerOutageTimetable() {
        CompletableFuture<List<PowerOutageItem>> getPowerOutageItemsFuture =
                donEnergoHttpClient.getPageContentAsync(URI.create(powerOutageUrls[0]))
