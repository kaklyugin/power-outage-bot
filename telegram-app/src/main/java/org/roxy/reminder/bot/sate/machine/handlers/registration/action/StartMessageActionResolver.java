...
public class StartMessageActionResolver extends ActionResolver {
    ...
    public static final String WELCOME_MESSAGE = """
            ...
            ❤️️️ Мы не храним ваши персональные данные.""";
    ...
    public Event resolveAction(UpdateDto update) {
        ...
        userCartService.deleteByChatId(update.getChatId());

        userSessionCacheService.deleteSession(update.getChatId());

        userSessionCacheService.createSession(update.getChatId());

        MessageDto welcomeMessage =
                MessageDto.builder()
                        .chatId(String.valueOf(update.getChatId()))
                        .text(WELCOME_MESSAGE)
                        .build();
        super.botClient.sendMessage(welcomeMessage);
